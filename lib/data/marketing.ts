...
/**
 * AI Content Operation 클라이언트
 * subCount: 인큐베이터/센터 안에서 운영한 입주기업 수
 *   (incubator 자체 카운트 X, 입주기업만 카운트)
 * subCount 미지정 = 단일 기업 (1)
 */
export type ContentOpClient = {
  name: string;
  subCount?: number;
};

export const AI_CONTENT_OP_CLIENTS: ContentOpClient[] = [
  { name: "성동청년이룸창업지원센터", subCount: 2 },
  { name: "고려대학교기술지주", subCount: 5 },
  { name: "제2서울핀테크랩", subCount: 5 },
  { name: "서울도시철도엔지니어링" },
  { name: "시스트란" },
  { name: "모두솔루션" },
  { name: "리부트라이프" },
